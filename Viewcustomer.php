...
if($search !=NULL){	
$sql = "Select * from tbl_inventory where ID LIKE '%$search%' OR PRODNAME LIKE '%$search%'";
}}else{
...
echo "</center>";
echo "<div class=txt>";
echo "<td colspan=7><p> Today, Marikina is known as <br>
...
echo "<tr>";
	...
	echo "<td>".$row['TOTAL'];
echo "<td><a href='display.php? id=".$row['ID']."'> Checkout </a>";
	echo "<tr>";
	echo "</table>";
	echo "</div>";
	echo "</center>";
